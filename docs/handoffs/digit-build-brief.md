...
## Source docs (preserved) and canonicalization (separate follow-up)

The five foundational docs (provided 2026-08-04) are preserved verbatim in [`../source-material/`](../source-material/README.md) so their nuance is not lost. Weaving their content into the structured canon is a later documentation pass — one reviewable doc at a time, not bundled. Recommended homes:
